...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // controller3 per getTalkByScore
  ...
  // metodo getTalksByTitle
  void _getTalksBy2Tags() async {
    setState(() {
      init = false;
      // set scelta
      sceltaopzione = 2;
      _talks = getTalksByTitle(_controller1.text.trimRight(), page);
    });
  }

  // metodo getTalkByScore
  void _getTalkByUrl() async {
    setState(() {
      init = false;
      // set scelta
      sceltaopzione = 3;
      _talks = getTalksByScore(page);
    });
  }
